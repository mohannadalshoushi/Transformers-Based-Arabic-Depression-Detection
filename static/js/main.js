...
class DepressionDetectionApp {
    ...
    handleTextInput(text) {
        // Filter out non-Arabic characters (keep Arabic, emojis, spaces, and basic punctuation)
        const filteredText = this.filterToArabicAndEmojis(text);
        
        if (filteredText !== text) {
            this.textInput.value = filteredText;
            text = filteredText;
        }
    ...
    filterToArabicAndEmojis(text) {
        // Allow Arabic characters, emojis, spaces, and basic Arabic punctuation
        return text.replace(/[^\u0600-\u06FF\u0750-\u077F\u08A0-\u08FF\uFB50-\uFDFF\uFE70-\uFEFF\u{1F300}-\u{1F5FF}\u{1F600}-\u{1F64F}\u{1F680}-\u{1F6FF}\u{1F700}-\u{1F77F}\u{1F780}-\u{1F7FF}\u{1F800}-\u{1F8FF}\u{1F900}-\u{1F9FF}\u{1FA00}-\u{1FA6F}\u{1FA70}-\u{1FAFF}\u{2600}-\u{26FF}\u{2700}-\u{27BF}\s\u060C\u061B\u061F\u0640]/gu, '');
    }
